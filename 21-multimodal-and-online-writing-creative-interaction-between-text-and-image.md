...
- The chapter moves through What modes are, and what combining them does, The rhetorical situation does not change; the questions do, Three principles, The genres — what each rewards, and related ideas.
...
![A single TikTok frame with each of the](images/21-multimodal-and-online-writing-creative-interaction-between-text-and-image-fig-01.png)
*Figure 21.1 — A single TikTok frame with each of the*
...
| genre | required accessibility features | what each feature enables — |
| --- | --- | --- |
| blog | Substack (alt text on images | A concrete checkpoint for applying the chapter concept. |
| video essay (captions, transcript | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. |
| podcast (transcript | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. |
| infographic (alt text, high-contrast color | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. |
| social media sequence (alt text per image, captions on video cards | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. |
| student treats this as a pre-publish checklist, not a post-publish add-on | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. |
...
| genre | dominant mode(s) | appropriate length | what the first element must do | what the last element must do |
| --- | --- | --- | --- | --- |
| genre comparison — | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. |
