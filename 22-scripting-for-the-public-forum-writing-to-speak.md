# Chapter 22 — Scripting for the Public Forum


## TL;DR

- Writing That Has to Be Spoken to Work.
- The chapter moves through The thing that makes a script different, The machinery of repetition, Structure at the scale of a five-to-ten minute talk, Delivery — the part the script does not fully control, and related ideas.
...
| Writing for the page (what it allows | why) | Writing for the ear (what it requires | why) | Root cause (the single constraint that makes each difference necessary) |
| --- | --- | --- | --- | --- |
| Sentence length, Repetition, Concrete language, Direct address. Columns: Writing for the page (what it allows and why | It makes the underlying reasoning visible instead of implied. | A specific, evidence-linked version that readers can verify. | It makes the underlying reasoning visible instead of implied. | A concrete checkpoint for applying the chapter concept. |
| Writing for the ear (what it requires and why | A specific, evidence-linked version that readers can verify. | A specific, evidence-linked version that readers can verify. | It makes the underlying reasoning visible instead of implied. | A concrete checkpoint for applying the chapter concept. |
| Root cause (the single constraint that makes each difference necessary). | A concrete checkpoint for applying the chapter concept. | A specific, evidence-linked version that readers can verify. | It makes the underlying reasoning visible instead of implied. | A concrete checkpoint for applying the chapter concept. |
...
| Technique used | Structural work it does | The move in one phrase |
| --- | --- | --- |
| Lincoln (Gettysburg | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. |
| Kennedy (Inaugural | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. |
| King ("I Have a Dream" | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. |
| Chief Joseph (surrender speech). Columns: Technique used, Structural work it does, The move in one phrase. Each passage key phrase quoted in the table. | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. |
...
![Linear flow diagram of a 5–10 minute talk](images/22-scripting-for-the-public-forum-writing-to-speak-fig-01.png)
*Figure 22.1 — Linear flow diagram of a 5–10 minute talk*
...
| What it does | Common error for beginning speakers | How to mark it in the script (stage direction notation) |
| --- | --- | --- |
| Pace, Pause, Pitch, Volume, Body | gesture. Columns: What it does, Common error for beginning speakers, How to mark it in the script (stage direction notation). | A concrete checkpoint for applying the chapter concept. |
...
**What you're building:** the script for your public-forum talk, sharpened by interrogation of delivery and structure before composition.

**Tool:** [Claude.ai](https://claude.ai/) chat. A Claude Project is recommended.

**The prompt:**

```
I'm writing a 700–1,500 word script (about 5–10 minutes of speaking
time) for a college writing class. The script is meant to be
delivered aloud — to a live audience, a recorded video, or a podcast.

The topic I'm scripting on: [name it]
The audience I'm speaking to: [be specific — students, professionals,
community members]
The medium: [live speech / recorded video / podcast / other]
The specific action or shift I want the audience to take after
listening: [name it]

Do the following in order, one step at a time, waiting for my response
between steps.

1. Suggest three possible openings for the script. Each should be
   under 100 words. Each should do three things: capture attention,
   establish credibility, and signal the topic. For each, name what
   it sacrifices and what it gains.

2. Ask me four diagnostic questions about my central argument. Where
   is it weakest? What is the strongest objection? What specific
   evidence would I most want to lead with?

3. Once I've answered, propose two or three structural arcs for the
   talk — what the body could look like. Three points? Two with a
   counterargument? A narrative arc with embedded argument? Name the
   trade-offs.

4. Once I've chosen a structure, identify three places in the talk
   where repetition, parallelism, or cadence work would land hardest.
   Propose specific phrases or structures.

5. Identify three places where a pause, a slowing of pace, or a
   shift in volume would do specific work. These will become stage
   directions in my script.

Do not draft the script. Do not write opening prose I can copy. The
writing is mine.
```

**What this produces:** three opening options, a diagnostic on the argument's weak points, a structural arc, three high-leverage moments for repetition/parallelism/cadence, three explicit delivery cues. After this, you draft the script yourself.
