...
- The chapter moves through What makes a review different from a reaction, The genre is older than the internet but the internet changed it, Choosing what to evaluate and why that choice matters, The most useful piece of craft advice for this genre, and related ideas.
...
![Triangle diagram with "criteria," "evidence," and "judgment" at](images/09-evaluation-or-review-would-you-recommend-it-fig-01.png)
*Figure 9.1 — Triangle diagram with "criteria," "evidence," and "judgment" at*
...
| element | reaction | review — |
| --- | --- | --- |
| criteria (absent vs. named | The pattern becomes easy to misuse or overlook. | A concrete checkpoint for applying the chapter concept. |
| evidence (vague vs. specific | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. |
| judgment (feeling vs. verdict a reader can use | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. |
| usefulness to an undecided reader (none vs. high | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. |
| student should be able to diagnose their own draft against this table | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. |
...
| weak generic criteria ("was it good | "was it interesting | "was it emotional") |
| --- | --- | --- |
| weak vs. strong criteria | two columns, six rows | left |
...
![Two-layer diagram ](images/09-evaluation-or-review-would-you-recommend-it-fig-02.png)
*Figure 9.2 — Two-layer diagram *
...
| task | verdict | reason — |
| --- | --- | --- |
| identify unsupported claims in your draft, argue against your criteria, construct the strongest opposite verdict, draft any part of the review, generate quotes from a work you've read, revise prose toward more specific criteria | A specific, evidence-linked version that readers can verify. | It makes the underlying reasoning visible instead of implied. |
| student scans this before opening the model | A concrete checkpoint for applying the chapter concept. | It makes the underlying reasoning visible instead of implied. |
