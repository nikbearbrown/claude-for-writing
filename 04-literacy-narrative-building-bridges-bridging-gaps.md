...
- The chapter moves through What happened at the well, What "literacy" actually means now, The mechanism: scene and summary, Three hinge moments, and related ideas.
...
![What changed at the well.](images/04-literacy-narrative-building-bridges-bridging-gaps-fig-01.png)
*Figure 4.1 — Two-column contrast *
...
![Grid or wheel of 8–10 literacy domains ](images/04-literacy-narrative-building-bridges-bridging-gaps-fig-02.png)
*Figure 4.2 — Grid or wheel of 8–10 literacy domains *
...
![The ratio is the argument: the writer's word-count tells you where the meaning lives.](images/04-literacy-narrative-building-bridges-bridging-gaps-fig-03.png)
*Figure 4.3 — Horizontal bar chart or timeline showing word-count vs*
...
| Item | Meaning |
| --- | --- |
| hinge duration, what is gained, what is lost or refused, structural technique used (ratio, pacing, expanded moment | A concrete checkpoint for applying the chapter concept. |
| whether the hinge is a single scene or a distributed rotation. | A concrete checkpoint for applying the chapter concept. |
