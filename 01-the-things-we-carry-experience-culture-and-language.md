...
- The chapter moves through What I mean by "carry", The room is not neutral, The thing that wasn't in anyone's pack five years ago, What the pack is not, and related ideas.
...
![Two-column visual contrasting "standard-issue" items (identical across every](images/01-the-things-we-carry-experience-culture-and-language-fig-01.png)
*Figure 1.1 — Two-column visual contrasting "standard-issue" items (identical across every*
...
| Community | Written form | Key conventions (2–3) |
| --- | --- | --- |
| hospital medicine (charts | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. |
| law (briefs | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. |
| skateboarding (forum posts | zines | A concrete checkpoint for applying the chapter concept. |
| academic writing (papers). | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. |
...
![Adding to the pack, not emptying it.](images/01-the-things-we-carry-experience-culture-and-language-fig-02.png)
*Figure 1.2 — Simple layered stack diagram showing literacy communities accumulating*
