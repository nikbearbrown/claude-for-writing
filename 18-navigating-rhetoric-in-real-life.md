...
- The chapter moves through The classroom audience was unusual, What the toolkit does in the real world, What the toolkit does not yet have, The LLM question in public-facing writing, and related ideas.
...
| dimension | classroom | real world — |
| --- | --- | --- |
| audience, how attentive they are by default, stakes, permanence of the piece, convention source, competition for attention | A concrete checkpoint for applying the chapter concept. | Audience, stakes, timing, and platform conventions shape the choice. |
| student uses this to see the shift systematically rather than just feeling it | A concrete checkpoint for applying the chapter concept. | Audience, stakes, timing, and platform conventions shape the choice. |
...
| skill | what it requires | where to develop it — |
| --- | --- | --- |
| headline | opening craft, visual integration, platform-specific conventions, receiving and using audience response, producing under time pressure | A concrete checkpoint for applying the chapter concept. |
| student sees what the remaining chapters will address and what they will need to develop through practice | A concrete checkpoint for applying the chapter concept. | A concrete checkpoint for applying the chapter concept. |
...
![Edward Said](../images/edward-said-7dk.png)
